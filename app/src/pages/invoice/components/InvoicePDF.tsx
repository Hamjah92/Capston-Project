...
export const InvoicePDF: FC<Props> = ({ invoice, currentStatus, customer }) => {
  const {
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body2}>Team7</Text>
            <Text style={styles.body2}>299 doon valley drive</Text>
            <Text style={styles.body2}>(519) 456-789</Text>
          </View>

          <View style={styles.col6}>
            <Text style={[styles.subtitle2, styles.mb4]}>Invoice to</Text>
            <Text style={styles.body2}>{customer.customerName}</Text>
            <Text style={styles.body2}>{customer.customerPhone}</Text>
          </View>
        </View>
        ...
        <View style={[styles.gridContainer, styles.mb40]}>
          <View style={styles.col6}>
            ...
            <Text style={styles.body2}>{fDate(invoiceDate)}</Text>
          </View>
          <View style={styles.col6}>
          ...
          <View>
            {items.map((item, index) => (
              <View style={styles.tableRow} key={index}>
                ...
                <View style={styles.tableCell_2}>
                  <Text style={styles.subtitle2}>{item.productId.productName}</Text>
                </View>
                ...
                <View style={[styles.tableCell_3, styles.alignRight]}>
                  <Text>{fCurrency(item.productTotal)}</Text>
                </View>
              </View>
            ))}
            ...
            <View style={[styles.tableRow, styles.noBorder]}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text>{fCurrency(shippingCost)}</Text>
              </View>
            </View>
            ...
            <View style={[styles.tableRow, styles.noBorder]}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text>{fCurrency(-((totalDiscountInPer * subTotal) / 100))}</Text>
              </View>
            </View>
            ...
            <View style={[styles.tableRow, styles.noBorder]}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text>{fCurrency(totalTaxInAmount)}</Text>
              </View>
            </View>
            ...
            <View style={[styles.tableRow, styles.noBorder]}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text style={styles.h4}>{fCurrency(netTotal)}</Text>
              </View>
            </View>
          </View>
        </View>
